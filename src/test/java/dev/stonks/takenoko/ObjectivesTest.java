...
class ObjectivesTest {
    ...
    void setUp() {
        ...
        PatternObjective obj3 = testMake.addAnPatternObjectives(6,1,pattern);
    ...
    void testFactoMaker() {
        ...
        deck = testMake.getlistObjectves();
        assertEquals(1, deck.size());
        PatternObjective newObj = new PatternObjective(1,7, pattern);
        PatternObjective newFacto = testMake.addAnPatternObjectives(7,1,pattern);
    ...
    void testObjectives(){
        ...
        PatternObjective obj1 = testMake.addAnPatternObjectives(5,1,pattern);
        PatternObjective obj2 = testMake.addAnPatternObjectives(6,1,pattern);
